...
const HttpRequestDialog = (
    ...
    const formInput = {
        ...
        endpoint: {
            type: "text",
            label: "Endpoint Url",
            description: "A request were made to this url when this node will be run.",
                ...
                <form className="space-y-4" onSubmit={form.handleSubmit(handleSubmit)}>
                    <FormField name="variable" control={form.control} render={({field})=>(
                        <FormItem>
                            ...
                            <FormControl>
                                <Input {...field} placeholder={formInput.variable.placeholder} />
                            </FormControl>
                            <FormDescription>{formInput.variable.description}</FormDescription>
                            <FormMessage />
                        </FormItem>
                    )} />
                    <FormField name={"endpoint"} control={form.control} render={({ field }) => (
                        <FormItem>
                            <FormLabel>{formInput.endpoint.label}</FormLabel>
                            <FormControl>
                                <Input {...field} placeholder={formInput.endpoint.placeholder} />
                            </FormControl>
                            <FormDescription>{formInput.endpoint.description}</FormDescription>
                            <FormMessage />
                        </FormItem>
                    )} />
                    <FormField
                    ...
                    <LabelInputContainer>
                        ...
                        <div className="space-y-2">
                            {headerFields.map((item, index) => (
                                <div className="flex flex-row gap-2 items-end" key={item.id}>
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem className="flex-1">
                                                <FormControl>
                                                    <Input {...field} placeholder={formInput.headers.placeholderKey} />
                                                </FormControl>
                                            </FormItem>
                                        )}
                                    />
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem className="flex-1">
                                                <FormControl>
                                                    <Input {...field} placeholder={formInput.headers.placeholderValue} />
                                                </FormControl>
                                            </FormItem>
                                        )}
                                    />
                                ...
                                <div className="flex flex-row gap-2 items-end" key={item.id}>
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem className="flex-1">
                                                <FormControl>
                                                    <Input {...field} placeholder={formInput.params.placeholderKey} />
                                                </FormControl>
                                            </FormItem>
                                        )}
                                    />
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem className="flex-1">
                                                <FormControl>
                                                    <Input {...field} placeholder={formInput.params.placeholderValue} />
                                                </FormControl>
                                            </FormItem>
                                        )}
                                    />
